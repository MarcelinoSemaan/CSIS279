...
export class vehicleController {
    ...
    @Get(':id')
    findDriverByDriverID(@Param('driverDriverID', ParseIntPipe) driverDriverID: number): Promise<Driver> {
        return this.vehicleService.findDriverByDriverID(driverDriverID);
    }
